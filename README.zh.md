...
> **v0.5.1** &nbsp;🆕&nbsp; [DeepXiv](https://github.com/DeepXiv/deepxiv_sdk) 集成 &nbsp;·&nbsp; 2026-04-10

- 🔍 论文搜索由 [DeepXiv](https://github.com/DeepXiv/deepxiv_sdk) 混合检索驱动（BM25 + 向量）— 替代 Semantic Scholar 和 OpenAlex
- 📖 **论文全文阅读** — Agent 通过渐进式工具阅读真实论文（`brief` → `head` → `section` → `full`），不再仅靠摘要
- 📝 深度研究文献综述现在能引用论文中的具体方法、实验结果和研究发现
- ⚙️ DeepXiv 令牌可在 **设置 > 集成服务** 中配置

<details>
<summary>历史版本</summary>

**v0.5.0** — 自主循环与相关文献 (2026-03-29)
